...
class IPSkill(OVOSSkill):
    ...
    @intent_handler("ip_intent.intent")
    ...
    def handle_wifi_signal_query(self, message):
        ...
        try:
            ...
            if quality:
                self.speak_dialog("wifi_signal", {"quality": quality})
            else:
                self.speak_dialog("ethernet_connection")

    @intent_handler("public_ip_intent.intent")
    ...
    @intent_handler("last_ip_digits_intent.intent")
